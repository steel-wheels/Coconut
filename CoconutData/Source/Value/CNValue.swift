...
public enum CNValue
{
	...
	public static func stringProperty(name nm: String, in dict: Dictionary<String, CNValue>) -> String? {
		guard let val = dict[nm] else {
			return nil
		}
		switch val {
	...
	public static func className(forValue dict: Dictionary<String, CNValue>) -> String? {
		return stringProperty(name: "class", in: dict)
	}
	...
	public static func arrayProperty(name nm: String, in dict: Dictionary<String, CNValue>) -> Array<CNValue>? {
		guard let val = dict[nm] else {
			return nil
		}
		switch val {
	...
	public static func dictionaryProperty(name nm: String, in dict: Dictionary<String, CNValue>) -> Dictionary<String, CNValue>? {
		guard let val = dict[nm] else {
			return nil
		}
		switch val {
