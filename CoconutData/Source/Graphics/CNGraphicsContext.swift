...
{
	public static let InterfaceName = "GraphicsContextIF"
	...
	static func allocateInterfaceType(rectIF rectif: CNInterfaceType, colorIF colif: CNInterfaceType) -> CNInterfaceType {
		typealias M = CNInterfaceType.Member
		let members: Array<M> = [
			M(name: "logicalFrame",		type: .interfaceType(rectif)),
			M(name: "setFillColor",		type: .functionType(.voidType, [.interfaceType(colif)])),
			M(name: "setStrrokeColor",	type: .functionType(.voidType, [.interfaceType(colif)])),
			M(name: "setPenSize",		type: .functionType(.voidType, [.numberType])),
			M(name: "moveTo",		type: .functionType(.voidType, [.numberType, .numberType])),
			M(name: "lineTo",		type: .functionType(.voidType, [.numberType, .numberType])),
			M(name: "rect",			type: .functionType(.voidType, [.numberType, .numberType, .numberType, .numberType, .boolType])),
			M(name: "circle", type: .functionType(.voidType, [.numberType, .numberType, .numberType, .boolType]))
		]
